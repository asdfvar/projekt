...
void Map::diagnostics( int *position_in )
{
   ...
   g_text.populate( blocks[ind++] );
   g_text.new_line();
   g_text.populate( write_permissions[26] );
   g_text.populate(" ");
   g_text.populate( write_permissions[23] );
   g_text.populate(" ");
   g_text.populate( write_permissions[20] );
   g_text.new_line();
   g_text.populate( write_permissions[25] );
   g_text.populate(" ");
   g_text.populate( write_permissions[22] );
   g_text.populate(" ");
   g_text.populate( write_permissions[19] );
   g_text.new_line();
   g_text.populate( write_permissions[24] );
   g_text.populate(" ");
   g_text.populate( write_permissions[21] );
   g_text.populate(" ");
   g_text.populate( write_permissions[18] );
   g_text.new_line();
   g_text.new_line();
   g_text.populate( write_permissions[17] );
   g_text.populate(" ");
   g_text.populate( write_permissions[14] );
   g_text.populate(" ");
   g_text.populate( write_permissions[11] );
   g_text.new_line();
   g_text.populate( write_permissions[16] );
   g_text.populate(" ");
   g_text.populate( write_permissions[13] );
   g_text.populate(" ");
   g_text.populate( write_permissions[10] );
   g_text.new_line();
   g_text.populate( write_permissions[15] );
   g_text.populate(" ");
   g_text.populate( write_permissions[12] );
   g_text.populate(" ");
   g_text.populate( write_permissions[9] );
   g_text.new_line();
   g_text.new_line();
   g_text.populate( write_permissions[8] );
   g_text.populate(" ");
   g_text.populate( write_permissions[5] );
   g_text.populate(" ");
   g_text.populate( write_permissions[2] );
   g_text.new_line();
   g_text.populate( write_permissions[7] );
   g_text.populate(" ");
   g_text.populate( write_permissions[4] );
   g_text.populate(" ");
   g_text.populate( write_permissions[1] );
   g_text.new_line();
   g_text.populate( write_permissions[6] );
   g_text.populate(" ");
   g_text.populate( write_permissions[3] );
   g_text.populate(" ");
   g_text.populate( write_permissions[0] );
}
